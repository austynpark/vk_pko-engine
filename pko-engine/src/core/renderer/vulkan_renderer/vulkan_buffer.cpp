                          ...
                          VmaAllocationCreateFlags alloc_create_flag, Buffer* buffer)
{
    ...
    VK_CHECK(vmaCreateBuffer(context->vma_allocator, &buffer_create_info, &alloc_create_info,
                        ...
                        u64 src_offset, u64 dst_offset)
{
    ...
    vkCmdCopyBuffer(one_time_submit.buffer, src_buffer->handle, dst_buffer->handle, 1,
                    &buffer_copy);
