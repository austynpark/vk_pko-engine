...
void vulkan_image_view_create(RenderContext* context, VkFormat format, Image* out_image, VkImageAspectFlags aspect_flags)
{
...
void vulkan_texture_create(RenderContext* context, vulkan_texture* out_texture, Image image, VkFilter filters, VkSamplerAddressMode samplerAdressMode)
{
...
void vulkan_texture_destroy(RenderContext* context, vulkan_texture* texture)
{
