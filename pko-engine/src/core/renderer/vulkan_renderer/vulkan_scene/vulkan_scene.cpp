...
b8 vulkan_scene::init(vulkan_context* api_context)
{
    ...
    //object_manager["boblampclean"]->position = glm::vec3(-1.7f, -1.5f, 0.0f);
    //object_manager["boblampclean"]->scale = glm::vec3(0.01f);
    ...
    object_manager["boxguy"]->position = glm::vec3(0.0f, 0.0f, 0.0f);
    object_manager["boxguy"]->scale = glm::vec3(0.01f);
	...
	//object_manager["tad"]->position = glm::vec3(0.0f, 0.0f, 0.0f);
    //object_manager["tad"]->scale = glm::vec3(0.5f);
    //object_manager["tad"]->rotation = glm::vec3(0.0f, 0.0f, 0.0f);
	...
	point_indicator = std::make_unique<vulkan_render_object>(context, "model/bulb.obj");
    point_indicator->position = glm::vec3(0, 0, 0);
    point_indicator->scale = glm::vec3(1.0f);
